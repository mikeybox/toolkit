...
module.exports = function(grunt) {
	grunt.initConfig({
		...
		cssjoin: {
			out: {
				...
				files: {
					"dist/debug/index.css":"css/index.css"
				}
		...
		requirejs: {
			compile:{
				options:{
					...
					// Also include the vendor configuration file.
					//vendorConfig: "app/config.js",
		...
		uglify: {
			...
			production:{
				files:{"dist/release/app.js":"dist/debug/require.js"}
			}
		},
	...
	grunt.task.registerTask("debug", ["clean", "jshint", "handlebars", "requirejs", "concat", "cssjoin"]);

	// The release task will run the debug tasks and then minify the
	// dist/debug/require.js file and CSS files.
	grunt.task.registerTask("release", ["debug", "uglify", "cssmin"]);
